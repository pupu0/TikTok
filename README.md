...
* iOS系统版本：16.2 （支持向下兼容）
* TikTok版本：Version 27.1.0（前置操作：从 [iTunes for Windows V 12.6.5.3](https://pan.baidu.com/s/1gLKF-W_GFhYgEYRP8yMA8g?pwd=Code) 抓包 TikTok Version 21.1.0 安装，登陆后观看视频、直播、评论、点赞、发布视频等模块都正常使用后，再从 App Store 升级至最新版方可使用！）
...
**法国**
```
https://raw.githubusercontent.com/pupu0/TikTok/master/Quantumult-X/TikTok.conf
```
...
```
https://raw.githubusercontent.com/pupu0/TikTok/master/Quantumult-X/TikTok.list, tag=TikTok, force-policy=TikTok, update-interval=86400, opt-parser=false, enabled=true
```
...
**法国**
```
https://raw.githubusercontent.com/pupu0/TikTok/master/Shadowrocket/TiKTok.conf
```
